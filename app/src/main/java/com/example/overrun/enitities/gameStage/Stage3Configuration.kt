...
fun Stage3Configuration(context: Context,
                        gameVM: GameViewModel)
{
    ...
    // 1 - Load Stage Map
    val map2DInt = context.readMapFileInto2DIntArray("map3.txt")
    ...
    when (hero.getHeroType())
    {
        ...
        eHeroType.eHERO_TOKAGE_YELLOW -> hero.setSpeed(DEFAULT_HERO_SPEED * 3U)
